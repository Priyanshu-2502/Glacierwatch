      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 font-[family-name:var(--font-playfair)] text-balance">
              Protecting Lives Through AI-Powered Glacier Intelligence
            </h1>
            <p className="text-xl text-black mb-8 max-w-2xl mx-auto text-pretty">
